<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
  ...
  <form action="?mod=sanpham&act=store" method="POST" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="TenSP" placeholder="" name="TenSP">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <input type="text" class="form-control" id="TenSanPham" placeholder="" name="TenSanPham" readonly hidden>
    </div>
    <div class="form-group">
