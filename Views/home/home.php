...
<div class="tab-products single-products extra-padding-top" style="padding:10px, background-color: #fff;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul style="margin-top:20px;">
                            <li class="active"><a data-toggle="tab" href="#arrival">Figure <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#popular">Gunpla <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#best">Khác</a></li>
...
<section class="collection-area collection-area2" style="padding:10px">
    <div class="container">
        <div class="row">
...
<section class="single-products  products-two extra-padding-bottom" style="padding:10px">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="section-title text-center">
