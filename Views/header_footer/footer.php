<footer class="footer-two">
    ...
    <div class="footer-top " style="padding:10px">
                            ...
                            <div class="footer-text">
                                <ul>
                                    <li>
                                        ...
                                        <p>65 Huỳnh Thúc Kháng, trường cao đẳng kỹ thuật Cao Thắng</p>
                                    </li>
                                    <li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 r-margin-top wide-mobile">
                        <div class="single-text">
                            ...
                            <div class="clearfix instagram">
                                <ul>
                                     <li><a href="https://www.facebook.com/profile.php?id=100049253956311&mibextid=kFxxJD" target="_blank"><img src="public/img/footer/fbicon.png" alt="Facebook" /></a></li>
                                     <li><a href="https://zalo.me/0912132758" target="_blank"><img src="https://cdn.haitrieu.com/wp-content/uploads/2022/01/Logo-Zalo-Arc.png" alt="Zalo" width="60" height="60" /></a></li>
                                     <li><a href="mailto:duccchoanggg758@gmail.com"><img src="public/img/footer/mailicon.png" alt="Email" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>&copy; Angel Figure Shop. All Rights Reserved.</p>
                </div>
