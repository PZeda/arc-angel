...
<?php if ($data != null) { ?>
                ...
                <div class="col-xs-12">
                    <div class="pages-title-text text-center">
                        <ul class="text-left">
                            ...
                            <li ><span> // </span><a class="shop-pg" href="?act=shop" >Cửa Hàng</a></li>
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8">
                        <div class="quick-right">
                            <div class="list-text">
                                ...
                                <?php }?>
                                <div class="list-btn"> 
                                    <a class="buy-btn" href="?act=cart&xuli=add&id=<?=$data['MaSP']?>">Mua Ngay</a>
                                    <?php if ($data['MaDM'] ) { ?>
                                        <a class="add-cart-btn" href="?act=cart&xuli=add&id=<?=$data['MaSP']?>">Thêm vào giỏ hàng</a>
    ...
    <section class="single-products " style="padding:10px">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
